        ...
        try {
            $response = $this->client->request(
                ...
                'https://api.authy.com/protected/json/users/new?api_key=' 
                    . config('awemapl-auth.two_factor.authy.secret'), [
        ...
        try {
            $response = $this->client->request(
                ...
                'https://api.authy.com/protected/json/verify/'
                    ...
                    . '?force=true&api_key=' . config('awemapl-auth.two_factor.authy.secret')
            );
        } catch (\Exception $e) {
            return false;
        }
        ...
        try {
            $response = $this->client->request(
                ...
                'https://api.authy.com/protected/json/users/delete/'
                    ...
                    . '?api_key=' . config('awemapl-auth.two_factor.authy.secret')
            );
        } catch (\Exception $e) {
            return false;
        }
        ...
        try {
            $response = $this->client->request(
                ...
                'https://api.authy.com/protected/json/users/'
                    . $user->twoFactor->identifier
                    . '/secret?api_key=' . config('awemapl-auth.two_factor.authy.secret')
            );
        } catch (\Exception $e) {
            return false;
        }
